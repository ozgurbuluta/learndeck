/*
  # Fix Ambiguous Column Reference in check_and_grant_achievements

  The function is still causing ambiguous column reference errors because
  variable names conflict with column names. This fix properly qualifies
  all column references to eliminate ambiguity.
*/

-- Fix the ambiguous column reference by using qualified column names
