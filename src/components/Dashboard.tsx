...
export const Dashboard: React.FC<DashboardProps> = ({ words, onNavigate, currentView: _currentView }) => {
  void _currentView;
  const { user } = useAuth();
  // Keeping folders commented but available for when we reactivate the folder feature
  ...
  // Keeping handleFolderStudy commented but available for when we reactivate the folder feature
  /*
